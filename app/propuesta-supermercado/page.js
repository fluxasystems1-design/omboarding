...
const CLIENTE = "Juan Pablo Moreno";
const CLIENTE_CORTO = "Juan Pablo";
const INSTAGRAM = "@juan.moreno.fx";
const FECHA = "Junio 2026";
const HEADER_LINE = `FLUXA METHOD | Propuesta Comercial | ${FECHA}`;
const WA_URL = "https://wa.me/573001234567?text=Hola%20Fluxa%20Method.%20Quiero%20hablar%20de%20mi%20visi%C3%B3n%20para%20el%20Paquete%203.";
...
/** Paquete 1 vs Paquete 2 — boolean = incluido; string = texto en celda */
const TRADING_PACKAGE_COMPARISON = [
...
const PROBLEMA_ITEMS = [
  ...
  `Sin automatización — cada interacción depende de ${CLIENTE_CORTO}.`,
...
const FRICTION_ITEMS = [
  ...
  },
  {
    ...
    d: "18 publicaciones en toda su historia. Instagram atrae interés, pero no hay una secuencia que convierta atención en demanda real.",
  },
  {
    t: "Dependencia 100% manual",
    d: `Cada venta requiere atención directa. Sin automatización, el crecimiento está limitado por las horas disponibles de ${CLIENTE_CORTO}.`,
  },
];
...
const TRANSFORMATIONS = [
  {
    n: 1,
    before: `El prospecto llega al perfil y no sabe qué ofrece ${CLIENTE_CORTO} ni cómo entrar. No hay un camino claro hacia la compra.`,
    after: `Landing page con VSL grabado por ${CLIENTE_CORTO} — el prospecto llega, entiende la propuesta y tiene un CTA claro para actuar.`,
  },
  {
    n: 2,
    before:
  ...
  {
    n: 4,
    before: `Cada venta depende de un mensaje manual de ${CLIENTE_CORTO}. Sin sistema, el crecimiento está limitado por su tiempo disponible.`,
    after: `Automatización completa de bienvenida, nutrición y agenda — el sistema trabaja y convierte sin requerir atención constante de ${CLIENTE_CORTO}.`,
  },
  {
    n: 5,
    before:
...
const FASES = [
  {
    ...
    result: `${CLIENTE_CORTO} tiene el guion listo y el ecosistema tomando forma.`,
  },
  {
    num: 2,
    when: "Semanas 2–3",
...
export default function PropuestaSupermercadoPage() {
  ...
  return (
    <main className="propuesta-supermercado min-h-screen bg-black text-white antialiased">
      ...
      <section className="mx-auto w-full max-w-6xl px-5 pb-10 pt-10 sm:px-8 md:pb-16 md:pt-20">
        <div data-reveal className="mx-auto max-w-4xl text-center">
          ...
          <div className="propuesta-bar-teal mx-auto mt-6 max-w-3xl px-4 py-3 text-sm font-semibold leading-relaxed text-teal-100 sm:text-base">
            ...
            <br />
            Un ecosistema digital que convierte el conocimiento y resultado de {CLIENTE_CORTO} en ingresos recurrentes —
        ...
        <div data-reveal className="mx-auto mt-10 max-w-5xl rounded-2xl border border-zinc-800 bg-[#0D0D0D] p-4 sm:p-8">
          ...
          <div className="propuesta-compare-table mt-6 overflow-x-auto rounded-xl border border-zinc-800 bg-black/40">
            <div className="min-w-[320px]">
              ...
              {TRADING_PACKAGE_COMPARISON.map((row) => (
                <div
                  key={row.feature}
      ...
      <PropuestaSection>
        <SectionHeader />
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">01. Dónde está hoy {CLIENTE}</p>
        <p className="mt-3 text-sm text-zinc-400 sm:text-base">
          Tiene resultado real y cuenta verificada, pero aún no tiene el sistema que lo monetice.
        </p>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-2">
          <article className="propuesta-card p-5 sm:p-6">
            ...
            <p className="mt-3 text-sm text-zinc-300">
              {CLIENTE_CORTO} es trader rentable desde 2022 con cuenta verificada — pero el prospecto no encuentra un
              camino claro desde su contenido hasta la compra.
            </p>
            <ul className="mt-4 space-y-2">
        ...
        <p className="propuesta-bar-teal mt-6 px-4 py-3 text-center text-sm font-semibold text-teal-100 sm:text-base">
          <strong>Conclusión:</strong> {CLIENTE_CORTO} tiene los 3 ingredientes más difíciles de conseguir — resultado real
          desde 2022, cuenta verificada y audiencia que confía en él. Lo que falta es el sistema que capte, nutra y
          convierta sin depender de su tiempo en cada paso.
        </p>
        <SlideFooter />
      </PropuestaSection>
      ...
      <PropuestaSection>
        ...
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">
          02. Las transformaciones concretas en 60 días
        </p>
        <p className="mt-3 text-sm text-zinc-400 sm:text-base">
      ...
      <PropuestaSection>
        <SectionHeader />
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">03. Qué recibe exactamente</p>
        <p className="mt-3 text-sm text-zinc-400 sm:text-base">
      ...
      <PropuestaSection>
        <SectionHeader />
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">04. Plan de ejecución — 2 meses</p>
        <p className="mt-3 text-sm text-zinc-400 sm:text-base">
      ...
      <PropuestaSection>
        <SectionHeader />
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">05. Forma de pago y condiciones</p>
        <p className="mt-3 text-sm text-zinc-400 sm:text-base">
          Una inversión clara, activos propios para {CLIENTE_CORTO} y soporte incluido.
        </p>
        ...
        <ul className="propuesta-card mt-6 list-none space-y-2 p-5 text-sm text-zinc-300 sm:p-6 sm:text-base">
          ...
          <li>La landing y todos los activos quedan publicados en el dominio propio de {CLIENTE_CORTO}.</li>
          <li>
            Los activos digitales son propiedad de {CLIENTE_CORTO} — sin dependencia de Fluxa Method tras la entrega.
          </li>
          <li>La pauta publicitaria y la suscripción a Skool se pagan directamente por {CLIENTE_CORTO}.</li>
        </ul>

        <p className="mt-6 text-center text-lg font-bold text-zinc-200 sm:text-xl">
          {CLIENTE_CORTO}, ya tienes el resultado. Fluxa Method pone el sistema.
        </p>
        <SlideFooter />
      </PropuestaSection>
      ...
      <PropuestaSection>
          ...
          <article className="propuesta-card border-teal-500/40 p-5">
            ...
            <StaggerItems
              items={[
                ...
                `Activos 100% propiedad de ${CLIENTE_CORTO}`,
        ...
        <p className="mt-6 text-center text-sm text-zinc-400 sm:text-base">
          Propuesta diseñada por Fluxa Method para convertir el conocimiento y resultado de {CLIENTE_CORTO} en una
      ...
      <PropuestaSection>
        <SectionHeader />
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-300">
          06. Tu próxima etapa — ¿qué construirías?
        </p>
        ...
        <p className="mt-3 text-sm text-zinc-300 sm:text-base">
          Dependiendo de lo que {CLIENTE_CORTO} quiera construir para su comunidad, el siguiente paso puede ser muy
        ...
        <div className="propuesta-card mt-6 flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
          ...
          <a href={WA_URL} target="_blank" rel="noopener noreferrer" className={`shrink-0 px-5 py-3 text-sm ${CTA_BTN}`}>
